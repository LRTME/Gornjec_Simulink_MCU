###########################################################################
## Makefile generated for component 'RLC_embedded_coder'. 
## 
## Makefile     : RLC_embedded_coder.mk
## Generated on : Wed Dec 21 15:41:01 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RLC_embedded_coder.out
...
PRODUCT_NAME              = RLC_embedded_coder
MAKEFILE                  = RLC_embedded_coder.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Jan/ONEDRI~1/DOCUME~1/FAKS/PODIPL~1/2_Letnik/Seminar/projekt
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RLC_embedded_coder.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/RLC_embedded_coder_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/shared/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/shared/SUPPOR~1/tic2000/inc -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/tic2000/inc -IC:/ti/CONTRO~1/DEVICE~1/f2806x/v151/F2806X~1/include -IC:/ti/CONTRO~1/DEVICE~1/f2806x/v151/F2806X~4/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil
...
DEFINES_STANDARD = -DMODEL=RLC_embedded_coder -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


RLC_embedded_coder.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/RLC_embedded_coder.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


RLC_embedded_coder_data.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/RLC_embedded_coder_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/RLC_embedded_coder_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
c2806xScheduler_ADCINT1.obj : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/tic2000/src/c2806xScheduler_ADCINT1.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
